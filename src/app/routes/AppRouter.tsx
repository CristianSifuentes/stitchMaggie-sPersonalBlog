...
const AntilibraryPage = lazy(() => import('@/features/antilibrary/views/AntilibraryPage').then((m) => ({ default: m.AntilibraryPage })));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: APP_ROUTES.antilibrary.slice(1), element: <AntilibraryPage /> },
